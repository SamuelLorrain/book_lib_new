...
from dialog_comportement import *
...
class Comportement:
    def __init__(self, mainFrameObject):
        if type(mainFrameObject) is not MainFrame:
            raise TypeError("l'objet entrée n'est pas de type MainFrame")

        self.main = mainFrameObject
        self.dialogcomportement = DialogComportement(self.main)
    ...
    def initEvent(self):
        ...
        #menu
        self.main.Bind(wx.EVT_MENU, self.dialogcomportement.showPreference,
                id=self.preferenceItem.GetId())
        self.main.Bind(wx.EVT_MENU, self.dialogcomportement.showExport,
                id=self.exportItem.GetId())
        self.main.Bind(wx.EVT_MENU, self.dialogcomportement.pressQuit,
                id=self.quitItem.GetId())

        self.main.Bind(wx.EVT_MENU, self.dialogcomportement.pressUndo,
                id=self.undoItem.GetId())
        self.main.Bind(wx.EVT_MENU, self.dialogcomportement.pressRedo,
                id=self.redoItem.GetId())

        self.main.Bind(wx.EVT_MENU, self.dialogcomportement.showAddBook,
                id=self.addBookItem.GetId())
        self.main.Bind(wx.EVT_MENU, self.dialogcomportement.showAddSubject,
                id=self.addSubjectItem.GetId())
        self.main.Bind(wx.EVT_MENU, self.dialogcomportement.showAddGenre,
                id=self.addGenreItem.GetId())
        self.main.Bind(wx.EVT_MENU, self.dialogcomportement.showAddAuthor,
                id=self.addAuthorItem.GetId())

        self.main.Bind(wx.EVT_MENU, self.dialogcomportement.showModBook,
                id=self.modBookItem.GetId())
        self.main.Bind(wx.EVT_MENU, self.dialogcomportement.showModSubject,
                id=self.modSubjectItem.GetId())
        self.main.Bind(wx.EVT_MENU, self.dialogcomportement.showModGenre,
                id=self.modGenreItem.GetId())
        self.main.Bind(wx.EVT_MENU, self.dialogcomportement.showModAuthor,
                id=self.modAuthorItem.GetId())

        self.main.Bind(wx.EVT_MENU, self.dialogcomportement.showApropos,
